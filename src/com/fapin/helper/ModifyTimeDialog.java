...
public class ModifyTimeDialog extends Dialog {
    ...
    public ModifyTimeDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public ModifyTimeDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final ModifyTimeDialog dialog = new ModifyTimeDialog(context, R.style.Dialog);
            mLayoutView = inflater.inflate(R.layout.dialog_modify_time, null);
