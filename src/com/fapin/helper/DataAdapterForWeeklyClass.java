...
public class DataAdapterForWeeklyClass extends BaseAdapter {
    private List<Map<String, String>> data;

    private LayoutInflater layoutInflater;

    public DataAdapterForWeeklyClass(Context context, List<Map<String, String>> data) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 获得组件，实例化组件
            convertView = layoutInflater.inflate(R.layout.list_weeklyclass, null);
            components.timeTextView = (TextView) convertView.findViewById(R.id.textview_time);
            components.curriculumDetailsTextView = (TextView) convertView
                    .findViewById(R.id.textview_curriculum_details);
            components.addressTextView = (TextView) convertView.findViewById(R.id.textview_address);
